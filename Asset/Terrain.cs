...
internal static class TerrainWriter {
    internal static async Task Write(string source) {
        ...
        await Sample(source, tiles, samples);
    ...
    private static void ExportCenters(string path) {
    ...
    private static async Task Sample(string source, string tiles, string samples) {
